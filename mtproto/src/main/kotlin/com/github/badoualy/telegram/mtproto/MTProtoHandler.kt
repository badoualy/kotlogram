...
class MTProtoHandler {
    ...
    private fun init() {
        watchdog = MTProtoWatchdog(connection!!)
    ...
    private fun handleMessage(message: MTMessage) {
        ...
        when (messageContent) {
            ...
            is MTBadMessageNotification -> handleBadMessage(messageContent)
            is MTBadServerSalt -> {
    ...
    @Throws(IOException::class)
    private fun handleBadMessage(badMessage: MTBadMessageNotification) {
