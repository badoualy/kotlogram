...
class NamedThreadFactory(val name: String, val singleThread: Boolean = false, val daemon: Boolean = true) : ThreadFactory {
    ...
    override fun newThread(r: Runnable): Thread {
        val t = Thread(group,
                       r,
                       if (singleThread) name else namePrefix + threadNumber.andIncrement,
                       0)
