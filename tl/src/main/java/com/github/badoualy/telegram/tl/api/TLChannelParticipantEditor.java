...
public class TLChannelParticipantEditor extends TLAbsChannelParticipant {
    public static final int CONSTRUCTOR_ID = 0x98192d61;

    protected int inviterId;

    protected int date;

    private final String _constructor = "channelParticipantEditor#98192d61";
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TLChannelParticipantEditor)) return false;
        if (object == this) return true;

        TLChannelParticipantEditor o = (TLChannelParticipantEditor) object;
