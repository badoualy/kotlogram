...
public abstract class TelegramReactiveApiWrapper implements TelegramReactiveApi {
    ...
    @Override
    public Observable<TLObject> invokeAfterMsg(long msgId, TLMethod query) throws IOException {
        return executeRpcQuery(new TLRequestInvokeAfterMsg(msgId, query));
    }

    @Override
    public Observable<TLObject> invokeAfterMsgs(com.github.badoualy.telegram.tl.core.TLLongVector msgIds, TLMethod query) throws IOException {
        return executeRpcQuery(new TLRequestInvokeAfterMsgs(msgIds, query));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLCheckedPhone> authCheckPhone(String phoneNumber) throws IOException {
        return executeRpcQuery(new TLRequestAuthCheckPhone(phoneNumber));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLAbsSentCode> authSendCode(String phoneNumber, int smsType, int apiId, String apiHash, String langCode) throws IOException {
        return executeRpcQuery(new TLRequestAuthSendCode(phoneNumber, smsType, apiId, apiHash, langCode));
    }

    @Override
    public Observable<TLBool> authSendCall(String phoneNumber, String phoneCodeHash) throws IOException {
        return executeRpcQuery(new TLRequestAuthSendCall(phoneNumber, phoneCodeHash));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLAuthorization> authSignUp(String phoneNumber, String phoneCodeHash, String phoneCode, String firstName, String lastName) throws IOException {
        return executeRpcQuery(new TLRequestAuthSignUp(phoneNumber, phoneCodeHash, phoneCode, firstName, lastName));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLAuthorization> authSignIn(String phoneNumber, String phoneCodeHash, String phoneCode) throws IOException {
        return executeRpcQuery(new TLRequestAuthSignIn(phoneNumber, phoneCodeHash, phoneCode));
    }

    @Override
    public Observable<TLBool> authLogOut() throws IOException {
        return executeRpcQuery(new TLRequestAuthLogOut());
    }

    @Override
    public Observable<TLBool> authResetAuthorizations() throws IOException {
        return executeRpcQuery(new TLRequestAuthResetAuthorizations());
    }

    @Override
    public Observable<TLBool> authSendInvites(com.github.badoualy.telegram.tl.core.TLStringVector phoneNumbers, String message) throws IOException {
        return executeRpcQuery(new TLRequestAuthSendInvites(phoneNumbers, message));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLExportedAuthorization> authExportAuthorization(int dcId) throws IOException {
        return executeRpcQuery(new TLRequestAuthExportAuthorization(dcId));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.auth.TLAuthorization> authImportAuthorization(int id, TLBytes bytes) throws IOException {
        return executeRpcQuery(new TLRequestAuthImportAuthorization(id, bytes));
    }

    @Override
    public Observable<TLBool> authBindTempAuthKey(long permAuthKeyId, long nonce, int expiresAt, TLBytes encryptedMessage) throws IOException {
        return executeRpcQuery(new TLRequestAuthBindTempAuthKey(permAuthKeyId, nonce, expiresAt, encryptedMessage));
    }

    @Override
    public Observable<TLBool> accountRegisterDevice(int tokenType, String token, String deviceModel, String systemVersion, String appVersion, boolean appSandbox, String langCode) throws IOException {
    ...
    @Override
    public Observable<TLBool> accountUnregisterDevice(int tokenType, String token) throws IOException {
        return executeRpcQuery(new TLRequestAccountUnregisterDevice(tokenType, token));
    }

    @Override
    public Observable<TLBool> accountUpdateNotifySettings(com.github.badoualy.telegram.tl.api.TLAbsInputNotifyPeer peer, com.github.badoualy.telegram.tl.api.TLInputPeerNotifySettings settings) throws IOException {
        return executeRpcQuery(new TLRequestAccountUpdateNotifySettings(peer, settings));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsPeerNotifySettings> accountGetNotifySettings(com.github.badoualy.telegram.tl.api.TLAbsInputNotifyPeer peer) throws IOException {
        return executeRpcQuery(new TLRequestAccountGetNotifySettings(peer));
    }

    @Override
    public Observable<TLBool> accountResetNotifySettings() throws IOException {
        return executeRpcQuery(new TLRequestAccountResetNotifySettings());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsUser> accountUpdateProfile(String firstName, String lastName) throws IOException {
        return executeRpcQuery(new TLRequestAccountUpdateProfile(firstName, lastName));
    }

    @Override
    public Observable<TLBool> accountUpdateStatus(boolean offline) throws IOException {
    ...
    @Override
    public Observable<com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsUser>> usersGetUsers(com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsInputUser> id) throws IOException {
        return executeRpcQuery(new TLRequestUsersGetUsers(id));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLUserFull> usersGetFullUser(com.github.badoualy.telegram.tl.api.TLAbsInputUser id) throws IOException {
        return executeRpcQuery(new TLRequestUsersGetFullUser(id));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLContactStatus>> contactsGetStatuses() throws IOException {
        return executeRpcQuery(new TLRequestContactsGetStatuses());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLAbsContacts> contactsGetContacts(String hash) throws IOException {
        return executeRpcQuery(new TLRequestContactsGetContacts(hash));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLImportedContacts> contactsImportContacts(com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLInputContact> contacts, boolean replace) throws IOException {
        return executeRpcQuery(new TLRequestContactsImportContacts(contacts, replace));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLSuggested> contactsGetSuggested(int limit) throws IOException {
        return executeRpcQuery(new TLRequestContactsGetSuggested(limit));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLLink> contactsDeleteContact(com.github.badoualy.telegram.tl.api.TLAbsInputUser id) throws IOException {
        return executeRpcQuery(new TLRequestContactsDeleteContact(id));
    }

    @Override
    public Observable<TLBool> contactsDeleteContacts(com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsInputUser> id) throws IOException {
        return executeRpcQuery(new TLRequestContactsDeleteContacts(id));
    }

    @Override
    public Observable<TLBool> contactsBlock(com.github.badoualy.telegram.tl.api.TLAbsInputUser id) throws IOException {
        return executeRpcQuery(new TLRequestContactsBlock(id));
    }

    @Override
    public Observable<TLBool> contactsUnblock(com.github.badoualy.telegram.tl.api.TLAbsInputUser id) throws IOException {
        return executeRpcQuery(new TLRequestContactsUnblock(id));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLAbsBlocked> contactsGetBlocked(int offset, int limit) throws IOException {
        return executeRpcQuery(new TLRequestContactsGetBlocked(offset, limit));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.core.TLIntVector> contactsExportCard() throws IOException {
        return executeRpcQuery(new TLRequestContactsExportCard());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsUser> contactsImportCard(com.github.badoualy.telegram.tl.core.TLIntVector exportCard) throws IOException {
        return executeRpcQuery(new TLRequestContactsImportCard(exportCard));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLAbsMessages> messagesGetMessages(com.github.badoualy.telegram.tl.core.TLIntVector id) throws IOException {
    ...
    @Override
    public Observable<TLBool> messagesSetTyping(com.github.badoualy.telegram.tl.api.TLAbsInputPeer peer, com.github.badoualy.telegram.tl.api.TLAbsSendMessageAction action) throws IOException {
    ...
    @Override
    public Observable<TLBool> messagesReportSpam(com.github.badoualy.telegram.tl.api.TLAbsInputPeer peer) throws IOException {
        return executeRpcQuery(new TLRequestMessagesReportSpam(peer));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLChats> messagesGetChats(com.github.badoualy.telegram.tl.core.TLIntVector id) throws IOException {
        return executeRpcQuery(new TLRequestMessagesGetChats(id));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLChatFull> messagesGetFullChat(int chatId) throws IOException {
    ...
    @Override
    public Observable<com.github.badoualy.telegram.tl.api.updates.TLState> updatesGetState() throws IOException {
        return executeRpcQuery(new TLRequestUpdatesGetState());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.updates.TLAbsDifference> updatesGetDifference(int pts, int date, int qts) throws IOException {
        return executeRpcQuery(new TLRequestUpdatesGetDifference(pts, date, qts));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsUserProfilePhoto> photosUpdateProfilePhoto(com.github.badoualy.telegram.tl.api.TLAbsInputPhoto id, com.github.badoualy.telegram.tl.api.TLAbsInputPhotoCrop crop) throws IOException {
        return executeRpcQuery(new TLRequestPhotosUpdateProfilePhoto(id, crop));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.photos.TLPhoto> photosUploadProfilePhoto(com.github.badoualy.telegram.tl.api.TLAbsInputFile file, String caption, com.github.badoualy.telegram.tl.api.TLAbsInputGeoPoint geoPoint, com.github.badoualy.telegram.tl.api.TLAbsInputPhotoCrop crop) throws IOException {
        return executeRpcQuery(new TLRequestPhotosUploadProfilePhoto(file, caption, geoPoint, crop));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.core.TLLongVector> photosDeletePhotos(com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsInputPhoto> id) throws IOException {
        return executeRpcQuery(new TLRequestPhotosDeletePhotos(id));
    }

    @Override
    public Observable<TLBool> uploadSaveFilePart(long fileId, int filePart, TLBytes bytes) throws IOException {
        return executeRpcQuery(new TLRequestUploadSaveFilePart(fileId, filePart, bytes));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.upload.TLFile> uploadGetFile(com.github.badoualy.telegram.tl.api.TLAbsInputFileLocation location, int offset, int limit) throws IOException {
        return executeRpcQuery(new TLRequestUploadGetFile(location, offset, limit));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLConfig> helpGetConfig() throws IOException {
        return executeRpcQuery(new TLRequestHelpGetConfig());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLNearestDc> helpGetNearestDc() throws IOException {
        return executeRpcQuery(new TLRequestHelpGetNearestDc());
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.help.TLAbsAppUpdate> helpGetAppUpdate(String deviceModel, String systemVersion, String appVersion, String langCode) throws IOException {
        return executeRpcQuery(new TLRequestHelpGetAppUpdate(deviceModel, systemVersion, appVersion, langCode));
    }

    @Override
    public Observable<TLBool> helpSaveAppLog(com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLInputAppEvent> events) throws IOException {
        return executeRpcQuery(new TLRequestHelpSaveAppLog(events));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.help.TLInviteText> helpGetInviteText(String langCode) throws IOException {
    ...
    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLAbsDhConfig> messagesGetDhConfig(int version, int randomLength) throws IOException {
        return executeRpcQuery(new TLRequestMessagesGetDhConfig(version, randomLength));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsEncryptedChat> messagesRequestEncryption(com.github.badoualy.telegram.tl.api.TLAbsInputUser userId, int randomId, TLBytes gA) throws IOException {
        return executeRpcQuery(new TLRequestMessagesRequestEncryption(userId, randomId, gA));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsEncryptedChat> messagesAcceptEncryption(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, TLBytes gB, long keyFingerprint) throws IOException {
        return executeRpcQuery(new TLRequestMessagesAcceptEncryption(peer, gB, keyFingerprint));
    }

    @Override
    public Observable<TLBool> messagesDiscardEncryption(int chatId) throws IOException {
        return executeRpcQuery(new TLRequestMessagesDiscardEncryption(chatId));
    }

    @Override
    public Observable<TLBool> messagesSetEncryptedTyping(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, boolean typing) throws IOException {
        return executeRpcQuery(new TLRequestMessagesSetEncryptedTyping(peer, typing));
    }

    @Override
    public Observable<TLBool> messagesReadEncryptedHistory(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, int maxDate) throws IOException {
        return executeRpcQuery(new TLRequestMessagesReadEncryptedHistory(peer, maxDate));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLAbsSentEncryptedMessage> messagesSendEncrypted(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, long randomId, TLBytes data) throws IOException {
        return executeRpcQuery(new TLRequestMessagesSendEncrypted(peer, randomId, data));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLAbsSentEncryptedMessage> messagesSendEncryptedFile(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, long randomId, TLBytes data, com.github.badoualy.telegram.tl.api.TLAbsInputEncryptedFile file) throws IOException {
        return executeRpcQuery(new TLRequestMessagesSendEncryptedFile(peer, randomId, data, file));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.messages.TLAbsSentEncryptedMessage> messagesSendEncryptedService(com.github.badoualy.telegram.tl.api.TLInputEncryptedChat peer, long randomId, TLBytes data) throws IOException {
        return executeRpcQuery(new TLRequestMessagesSendEncryptedService(peer, randomId, data));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.core.TLLongVector> messagesReceivedQueue(int maxQts) throws IOException {
        return executeRpcQuery(new TLRequestMessagesReceivedQueue(maxQts));
    }

    @Override
    public Observable<TLBool> uploadSaveBigFilePart(long fileId, int filePart, int fileTotalParts, TLBytes bytes) throws IOException {
        return executeRpcQuery(new TLRequestUploadSaveBigFilePart(fileId, filePart, fileTotalParts, bytes));
    }

    @Override
    public <T extends TLObject> Observable<T> initConnection(int apiId, String deviceModel, String systemVersion, String appVersion, String langCode, TLMethod<T> query) throws IOException {
        return executeRpcQuery(new TLRequestInitConnection(apiId, deviceModel, systemVersion, appVersion, langCode, query));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.help.TLSupport> helpGetSupport() throws IOException {
        return executeRpcQuery(new TLRequestHelpGetSupport());
    }

    @Override
    public Observable<TLBool> authSendSms(String phoneNumber, String phoneCodeHash) throws IOException {
    ...
    @Override
    public Observable<TLBool> accountCheckUsername(String username) throws IOException {
        return executeRpcQuery(new TLRequestAccountCheckUsername(username));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.TLAbsUser> accountUpdateUsername(String username) throws IOException {
        return executeRpcQuery(new TLRequestAccountUpdateUsername(username));
    }

    @Override
    public Observable<com.github.badoualy.telegram.tl.api.contacts.TLFound> contactsSearch(String q, int limit) throws IOException {
