...
public class TLResolvedPeer extends TLObject {
    ...
    public TLResolvedPeer(        com.github.badoualy.telegram.tl.api.TLAbsPeer _peer,         com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsChat> _chats,         com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsUser> _users) {
        this.peer = _peer;
        this.chats = _chats;
        this.users = _users;
