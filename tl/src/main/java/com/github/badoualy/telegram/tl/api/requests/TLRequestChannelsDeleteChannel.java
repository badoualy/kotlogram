...
public class TLRequestChannelsDeleteChannel extends TLMethod<com.github.badoualy.telegram.tl.api.TLAbsUpdates> {
    ...
    public TLRequestChannelsDeleteChannel(        com.github.badoualy.telegram.tl.api.TLAbsInputChannel _channel) {
