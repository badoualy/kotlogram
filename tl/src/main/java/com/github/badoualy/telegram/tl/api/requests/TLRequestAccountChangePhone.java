...
public class TLRequestAccountChangePhone extends TLMethod<com.github.badoualy.telegram.tl.api.TLAbsUser> {
    ...
    public TLRequestAccountChangePhone(        String _phoneNumber,         String _phoneCodeHash,         String _phoneCode) {
