...
public class TLInputBotInlineResult extends TLObject {
    ...
    public TLInputBotInlineResult(        int _flags,         String _id,         String _type,         String _title,         String _description,         String _url,         String _thumbUrl,         String _contentUrl,         String _contentType,         int _w,         int _h,         int _duration,         com.github.badoualy.telegram.tl.api.TLAbsInputBotInlineMessage _sendMessage) {
        this.flags = _flags;
        this.id = _id;
        this.type = _type;
        this.title = _title;
    ...
    protected com.github.badoualy.telegram.tl.api.TLAbsInputBotInlineMessage sendMessage;
    ...
    public com.github.badoualy.telegram.tl.api.TLAbsInputBotInlineMessage getSendMessage() {
        return sendMessage;
    }

    public void setSendMessage(com.github.badoualy.telegram.tl.api.TLAbsInputBotInlineMessage value) {
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        this.sendMessage = (com.github.badoualy.telegram.tl.api.TLAbsInputBotInlineMessage)readTLObject(stream, context);
    }
