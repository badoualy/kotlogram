...
public class TLBotInlineMessageText extends TLAbsBotInlineMessage {
    ...
    public TLBotInlineMessageText(        int _flags,         boolean _noWebpage,         String _message,         com.github.badoualy.telegram.tl.core.TLVector<com.github.badoualy.telegram.tl.api.TLAbsMessageEntity> _entities) {
        this.flags = _flags;
