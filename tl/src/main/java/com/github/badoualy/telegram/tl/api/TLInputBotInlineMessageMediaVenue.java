...
public class TLInputBotInlineMessageMediaVenue extends TLAbsInputBotInlineMessage {
    ...
    public static final int CONSTRUCTOR_ID = 0xaaafadc8;
    ...
    private final String _constructor = "inputBotInlineMessageMediaVenue#aaafadc8";

    public TLInputBotInlineMessageMediaVenue() {
    }

    public TLInputBotInlineMessageMediaVenue(TLAbsInputGeoPoint geoPoint, String title, String address, String provider, String venueId, TLAbsReplyMarkup replyMarkup) {
