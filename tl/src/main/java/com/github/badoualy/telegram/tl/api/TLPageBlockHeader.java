 ...
 */
public class TLPageBlockHeader extends TLAbsPageBlock {

    public static final int CONSTRUCTOR_ID = 0xbfd064ec;

    protected TLAbsRichText text;

    private final String _constructor = "pageBlockHeader#bfd064ec";

    public TLPageBlockHeader() {
    }

    public TLPageBlockHeader(TLAbsRichText text) {
        this.text = text;
    }
