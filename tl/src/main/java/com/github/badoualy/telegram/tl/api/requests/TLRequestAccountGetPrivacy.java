...
public class TLRequestAccountGetPrivacy extends TLMethod<com.github.badoualy.telegram.tl.api.account.TLPrivacyRules> {
    ...
    public TLRequestAccountGetPrivacy(        com.github.badoualy.telegram.tl.api.TLInputPrivacyKey _key) {
        this.key = _key;
