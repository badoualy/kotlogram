...
public class TLRequestAuthSendSms extends TLMethod<TLBool> {
    public static final int CONSTRUCTOR_ID = 0xda9f3e8;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TLRequestAuthSendSms)) return false;
        if (object == this) return true;

        TLRequestAuthSendSms o = (TLRequestAuthSendSms) object;
