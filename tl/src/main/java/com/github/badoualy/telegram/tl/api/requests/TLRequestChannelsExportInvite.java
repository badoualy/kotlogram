...
public class TLRequestChannelsExportInvite extends TLMethod<com.github.badoualy.telegram.tl.api.TLAbsExportedChatInvite> {
    ...
    public TLRequestChannelsExportInvite(        com.github.badoualy.telegram.tl.api.TLAbsInputChannel _channel) {
