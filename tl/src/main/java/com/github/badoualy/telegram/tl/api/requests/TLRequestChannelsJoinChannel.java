...
public class TLRequestChannelsJoinChannel extends TLMethod<com.github.badoualy.telegram.tl.api.TLAbsUpdates> {
    ...
    public TLRequestChannelsJoinChannel(        com.github.badoualy.telegram.tl.api.TLAbsInputChannel _channel) {
