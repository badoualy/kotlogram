...
public class TLUserContact extends TLAbsUser {
    ...
    public TLUserContact(        int _id,         String _firstName,         String _lastName,         String _username,         long _accessHash,         String _phone,         com.github.badoualy.telegram.tl.api.TLAbsUserProfilePhoto _photo,         com.github.badoualy.telegram.tl.api.TLAbsUserStatus _status) {
        this.id = _id;
