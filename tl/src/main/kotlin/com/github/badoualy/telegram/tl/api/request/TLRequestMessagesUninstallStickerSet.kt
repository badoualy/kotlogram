 ...
 */
class TLRequestMessagesUninstallStickerSet() : TLMethod<TLBool>() {
    var stickerset: TLAbsInputStickerSet = TLInputStickerSetEmpty()

    private val _constructor: String = "messages.uninstallStickerSet#f96e55de"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesUninstallStickerSet) return false
        if (other === this) return true

        return stickerset == other.stickerset
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xf96e55de.toInt()
    }
}
