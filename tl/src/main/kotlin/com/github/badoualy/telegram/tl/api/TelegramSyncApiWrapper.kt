...
abstract class TelegramSyncApiWrapper : TelegramSyncApi, RpcQuerySyncExecutor {
    ...
    override fun channelsGetParticipants(
            ...
            offset: Int,
            limit: Int
    ): TLChannelParticipants = executeRpcQuerySync(TLRequestChannelsGetParticipants(channel, filter, offset, limit))
    ...
    override fun messagesEditMessage(
            ...
            replyMarkup: TLAbsReplyMarkup?,
            entities: TLObjectVector<TLAbsMessageEntity>?
    ): TLAbsUpdates = executeRpcQuerySync(TLRequestMessagesEditMessage(noWebpage, peer, id, message, replyMarkup, entities))
