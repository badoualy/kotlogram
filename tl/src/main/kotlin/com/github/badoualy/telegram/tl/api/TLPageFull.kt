...
class TLPageFull() : TLAbsPage() {
    ...
    private val _constructor: String = "pageFull#556ec7aa"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLPageFull) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x556ec7aa.toInt()
    }
}
