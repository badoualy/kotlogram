...
/**
 * messages.foundStickerSets#5108d648
 *
...
class TLFoundStickerSets() : TLAbsFoundStickerSets() {
    ...
    private val _constructor: String = "messages.foundStickerSets#5108d648"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(hash: Int, sets: TLObjectVector<TLAbsStickerSetCovered>) : this() {
        this.hash = hash
        this.sets = sets
    }
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x5108d648.toInt()
    }
}
