...
class TLRequestAuthRequestPasswordRecovery : TLMethod<TLPasswordRecovery>() {
    ...
    override fun deserializeResponse_(tlDeserializer: TLDeserializer): TLPasswordRecovery = tlDeserializer.readTLObject(TLPasswordRecovery::class, TLPasswordRecovery.CONSTRUCTOR_ID)
